...
Bot **kendi kendine otomatik alım yapmaz**. Alım yalnızca Telegram’daki çift onaylı “AL” butonuyla gönderilir.
...
- Solscan linki
- Yoksay butonu
- Cüzdan tanımlıysa çift onaylı hızlı AL butonu
...
`AL` ve `Pozisyonu Kapat` butonları sadece `WALLET_PRIVATE_KEY` tanımlıysa çalışır ve
